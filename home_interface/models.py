...
class Competition(models.Model):
    ...
    category = models.PositiveSmallIntegerField(choices=CATEGORY_CHOICES,default=1)  #竞赛类别
...
class Discussion(models.Model):
    ...
    competition = models.ForeignKey(Competition, on_delete=models.CASCADE, related_name='discussions',default=1)
